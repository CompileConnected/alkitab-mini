      ...
      check: async () => {
        ...
        if (typeof window !== 'undefined' && window?.ai?.languageModel) {
          ...
          try {
            ...
            const avail =
              typeof window.ai.languageModel.availability === 'function'
        ...
        if (typeof window !== 'undefined' && 'translation' in window) {
          ...
          try {
            ...
            set(
              { translationApi },
              false,
              `check/translationApi/${translationApi}`
            );
          } catch {
            set(
              { translationApi: 'unavailable' },
              false,
              'check/translationApi/error'
            );
          }
        } else if (typeof window !== 'undefined') {
          set(
